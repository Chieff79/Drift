...
import 'package:hiddify/features/proxy/overview/country_selection_page.dart';
...
import 'package:hiddify/features/splash/widget/splash_screen.dart';
  ...
  RoutingConfig build() {
    ...
    return RoutingConfig(
      redirect: (context, state) {
        // Let the splash screen display without redirection
      ...
      routes: <RouteBase>[
                ...
                GoRoute(
                  ...
                  routes: <GoRoute>[
                    ...
                    GoRoute(
                      ...
                      pageBuilder: (_, state) =>
                          customTransition(TransitionType.fade, state.pageKey, const CountrySelectionPage()),
                    ),
        ...
        GoRoute(name: 'splash', path: '/splash', builder: (_, _) => const SplashScreen()),
      ],
    );
  }
}
