...
import com.drift.vpn.constant.Alert
...
import com.drift.vpn.BuildConfig
import com.drift.vpn.MainActivity
import com.drift.vpn.constant.Bugs
            ...
            val newService = try {
                Mobile.setup(
                    SetupOptions().also {
                        ...
                        it.fixAndroidStack = com.drift.vpn.bg.Bugs.fixAndroidStack
