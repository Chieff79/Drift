...
import com.drift.vpn.bg.BoxService
//import com.drift.vpn.bg.BoxService.Companion.workingDir
...
class MethodHandler(private val scope: CoroutineScope) : FlutterPlugin,
    ...
    companion object {
        ...
        const val channelName = "com.drift.vpn/method"
