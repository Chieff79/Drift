...
import com.drift.vpn.Application
import com.drift.vpn.MainActivity
import com.drift.vpn.R
import com.drift.vpn.Settings
import com.drift.vpn.constant.Action
import com.drift.vpn.constant.Status
//import com.drift.vpn.utils.CommandClient
import com.hiddify.core.libbox.Libbox
import com.drift.vpn.Application.Companion.notification
import com.drift.vpn.utils.GrpcClientProvider
    ...
    fun show(profileName: String, @StringRes contentTextId: Int) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            Application.notification.createNotificationChannel(
                NotificationChannel(
                    notificationChannel, "Drift VPN Service", NotificationManager.IMPORTANCE_LOW
                )
            )
        }
        service.startForeground(
            notificationId, notificationBuilder
                .setContentTitle(profileName.takeIf { it.isNotBlank() } ?: "Drift VPN")
